...
import { Github, Linkedin, Mail, Code, Briefcase, GraduationCap, BookOpen, Package, HomeIcon, FileText } from "lucide-react";
...
export default function Home() {
    ...
    // ページの切り替え関数
    const togglePage = (page: "home" | "resume") => {
        setCurrentPage(page);
    };

    // サイドバーコンポーネント
    const Sidebar = () => (
        <div className="bg-background border-r flex flex-col h-screen fixed">
            <div className="p-4">
                                        ...
                                        <div className="space-y-6">
                                            ...
                                            <div>
                                                <div className="flex justify-between items-start">
                                                    ...
                                                    <span className="text-sm text-muted-foreground">2017.04 - 2021.03</span>
                                                </div>
                                                <p className="mt-2">
                                                    Only hang out :)
                                                </p>
    ...
    return (
        <div className="flex min-h-screen">
            {/* サイドバー */}
            <div className="flex-none w-1/10 pt-20">
                <Sidebar />
            </div>
            {/* メインコンテンツエリア */}
            <div className="ml-1/10 flex-1">
                <SiteHeader />
                <MainContent />
            </div>
        </div>
